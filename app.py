...
if __name__ == '__main__':
    ...
    st.write("The group of marine Chordata (fish) is displayed per default. Other groups can be displayed by selecting "
            "the radio button of the corresponding group in the sidebar.")
